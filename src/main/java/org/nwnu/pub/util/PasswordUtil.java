...
public class PasswordUtil {
	 ...
	 * 解密密文字符串
	 * 
	 *encrypt()参数说明：String ciphertext, String password, byte[] salt
	 *	ciphertext:是数据库中的加密字符串；
	 *	password: 是你输入的密码，也就是你原来未加密的字符串；
	 *	salt: 盐值(如需解密,该参数需要与加密时使用的一致)；
	 *
	 * @param ciphertext
	 *            待解密的密文字符串
	 * @param password
...
//
//		com.nwnu.averweb.util.LogUtil.info("明文:" + str);
//		com.nwnu.averweb.util.LogUtil.info("密码:" + password);
//
//		try {
//			byte[] salt = PasswordUtil.getStaticSalt();
//			String ciphertext = PasswordUtil.encrypt(str, password, salt);
//			com.nwnu.averweb.util.LogUtil.info("密文:" + ciphertext);
//			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
//			com.nwnu.averweb.util.LogUtil.info("明文:" + plaintext);
//
//			String result = PasswordUtil.decrypt("ea3d519525358e00", "root", salt);
//			com.nwnu.averweb.util.LogUtil.info("明文:" + result);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//	}
